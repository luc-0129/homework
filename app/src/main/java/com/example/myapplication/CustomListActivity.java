...
import static junit.textui.TestRunner.run;
...
public class CustomListActivity extends ListActivity implements AdapterView.OnItemClickListener {
...
//                    listItemAdapter=new SimpleAdapter(CustomListActivity.this,listItems,R.layout.list_item,new String[]{"ItemTitle","Price"},new int[]{R.id.itemTitle,R.id.price});
                    MyAdapter adapter=new MyAdapter(CustomListActivity.this,R.layout.list_item,listItems);
